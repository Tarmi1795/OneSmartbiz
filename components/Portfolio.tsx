...
const projects = [
  {
    ...
    title: "Artefakt",
    category: "Video",
    description: "A premier high-end multimedia production studio specializing in commercial VFX and unconventional visual storytelling for global brands.",
  ...
  },
  {
    ...
    title: "Studio X",
    category: "Branding",
    description: "A senior-led branding agency and design studio, optimizing physical-digital environments to enhance customer experience (CX) and business performance.",
  ...
  },
  {
    ...
    title: "365days+1",
    category: "Web Design",
    description: "A masterclass in immersive web design and digital art, featuring a contemplative narrative journey through 366 custom AI-enhanced paintings.",
  ...
  },
  {
    ...
    title: "Utopia Tokyo",
    category: "Branding",
    description: "A cyberpunk-inspired branding architecture and digital experience, exploring narrative-driven storytelling in a high-tech urban landscape.",
