...
const posts: Record<string, { title: string; description: string; keywords: string; date: string; category: string; content: string[] }> = {
  "web-development-doha-guide-2026": {
    ...
    content: [
      ...
      "|------|-------------------|----------|",
      "| Landing Page | 750 - 1,500 | 3-7 days |",
      "| Business Website | 1,500 - 4,500 | 1-3 weeks |",
      "| E-Commerce | 4,500 - 9,500 | 3-6 weeks |",
      "| Custom Web App | 9,500 - 35,000+ | 6-12 weeks |",
  ...
  "cost-build-custom-website-qatar": {
    ...
    content: [
      ...
      "|--------------|-------------------|------------------|",
      "| Simple Landing Page | 750 - 1,500 | Contact Form, Core Sections |",
      "| Small Business Site | 1,500 - 4,500 | 5-10 Pages, SEO, CMS Option |",
      "| E-Commerce Portal | 4,500 - 9,500 | Payment Gateway, Product Catalog |",
      "| Custom Web App | 9,500+ | Custom API, Dashboard, Scalable Cloud |",
      "## Quality Over Cost",
  ...
  "cost-20-page-website-qatar-breakdown": {
    ...
    content: [
      ...
      "|-----------|-------------------|-------|",
      "| Strategy & Sitemap | 750 - 1,500 | Information Architecture |",
      "| UX/UI Design | 2,000 - 4,500 | Bespoke layout system for 20 pages |",
      "| Development | 5,000 - 10,000 | Next.js/React preferred |",
      "| SEO & Content | 1,500 - 3,500 | Bilingual optimization support |",
      "| **Total Estimate** | **9,250 - 19,500** | Full professional solution |",
      "## Why 20 Pages?",
  ...
  "middle-east-website-design-trends-2026": {
    ...
    content: [
      ...
      "4. **Budget and Timeline**: Expect costs ranging from $1,000-$12,000 depending on complexity. Top firms in Dubai or Beirut offer competitive rates with quick turnarounds (2-10 weeks).",
